...
export const TypewriterBlock: React.FC<TypewriterBlockProps> = (props) => {
    ...
    return (
        <TAG className='typewriter-block-content-text'>{prefix} <span className={`typedTextColor-${typedTextColor} typewriter-block-content-text-typed`} ref={typedRef}></span> {suffix}</TAG>
    )
}